...
[extra]
thumbnail = "images/portfolio/papers/rho-jpsi-vector-mesons-gpds.webp"
service = "Phys. Rev. D 112 (2025)"
client = "Tanisha, S. Puhan, A. Yadav, and H. Dahiya"
short_description = "Unraveling the unpolarized quark GPDs of rho and J/ψ mesons, deriving charge, magnetic, and quadrupole form factors with NNLO-evolved PDFs."
...
solution = "Studies unpolarized quark GPDs of rho and J/psi mesons using the LCQM. Derives charge, magnetic, and quadrupole form factors and Rosenbluth structure functions, with PDFs evolved to 5 GeV^2 via NNLO DGLAP."
tags = ["GPDs", "PDFs", "Rho Meson", "J/psi", "Light-Front Dynamics"]
