...
"""
    },
    {
        ...
        "description": "Investigation of the energy-momentum tensor and GFFs of pseudoscalar charmonium and bottomonium in the light-front quark model.",
        "link_label": "Read on arXiv",
...
for p in pubs + confs:
    p_copy = p.copy()
    if 'thumbnail' not in p_copy:
        p_copy['thumbnail'] = "images/portfolio/portfolio-1.png"
    content = file_template.format(**p_copy)
